  ...
  METHOD factory.
    ...
    CASE iv_tool.
      WHEN cl_enh_tool_badi_impl=>tooltype.
        ri_enho = NEW zcl_abapgit_object_enho_badi( is_item = ms_item io_files = mo_files ).
      WHEN cl_enh_tool_hook_impl=>tooltype.
        ri_enho = NEW zcl_abapgit_object_enho_hook( is_item = ms_item io_files = mo_files ).
      WHEN cl_enh_tool_class=>tooltype.
        ri_enho = NEW zcl_abapgit_object_enho_class( is_item = ms_item io_files = mo_files ).
      WHEN cl_enh_tool_intf=>tooltype.
        ri_enho = NEW zcl_abapgit_object_enho_intf( is_item = ms_item io_files = mo_files ).
      WHEN cl_wdr_cfg_enhancement=>tooltype.
        ri_enho = NEW zcl_abapgit_object_enho_wdyc( is_item = ms_item io_files = mo_files ).
      WHEN 'FUGRENH'.
        ri_enho = NEW zcl_abapgit_object_enho_fugr( is_item = ms_item io_files = mo_files ).
      WHEN 'WDYENH'.
        ri_enho = NEW zcl_abapgit_object_enho_wdyn( is_item = ms_item io_files = mo_files ).
      WHEN OTHERS.
