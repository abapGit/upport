...
CLASS zcl_abapgit_gui_router IMPLEMENTATION.
  ...
  METHOD general_page_routing.
    ...
    CASE is_event_data-action.
      ...
      WHEN zif_abapgit_definitions=>c_action-go_repo_overview.               " Go Repository overview
        ei_page = NEW zcl_abapgit_gui_page_repo_over( ).
        ev_state = zcl_abapgit_gui=>c_event_state-new_page.
  ...
  METHOD get_page_diff.
    ...
    lo_page = NEW #( iv_key = lv_key is_file = ls_file is_object = ls_object ).
  ...
  METHOD get_page_stage.
    ...
    ELSE.
      ...
      lo_stage_page = NEW #( io_repo = lo_repo iv_seed = lv_seed ).
