...
* only the main XML file is used for comparison
    ...
    IF is_result-filename CS '.XML' AND lv_count = 2.
      ...
      lo_remote_version = NEW #( iv_xml = zcl_abapgit_convert=>xstring_to_string_utf8( ls_remote_file-data ) iv_filename = ls_remote_file-filename ).
  ...
  METHOD deserialize.
    ...
    LOOP AT lt_results ASSIGNING <ls_result>.
      ...
      TRY.
          ...
          lo_files = NEW #( is_item = ls_item iv_path = lv_path ).
